...
import com.example.day5cw1.service.EJIProductService;
...
public class EJIProductController {
    ...
    public ResponseEntity<EJIProduct> putMethodName(@PathVariable("productId") int id, @RequestBody EJIProduct product) {
    ...
    public ResponseEntity<EJIProduct> delete(@PathVariable("productId") int id,@RequestBody EJIProduct product)
    {
