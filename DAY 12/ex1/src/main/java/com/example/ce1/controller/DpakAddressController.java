...
import com.example.ce1.service.EJIAddressService;
...
public class DpakAddressController {
    ...
    @Autowired
    EJIAddressService addressService;

    @SuppressWarnings("null")
    @PostMapping("/address/employee/{id}")
    public ResponseEntity<EJIAddress> postMethodName(@RequestBody EJIAddress address,@PathVariable int id) {
